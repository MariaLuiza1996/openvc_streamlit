...
def principal():
    ...
    st.subheader("Esse aplicativo web permite integrar processamento de imagens com Open CV")
    ...
    image_original = Image.open(arquivo_imagem)
    image_original = np.array(image_original)

    imagem_processada = borra_imagem(image_original, taxa_borrao)
    ...
    st.image([image_original, imagem_processada])
